...
import { LOAD_CHARACTERS, loadCharacters, LOAD_CHARACTER_INFO ,loadCharacterInfo} from "../characters.actions";
...
describe('characters.actions', () => {
  ...
  it('should create an action to load character info', () => {
    ...
    const expectedActions = [{ 'character': {'id': 1}, 'id': 1, 'type': LOAD_CHARACTER_INFO }];
